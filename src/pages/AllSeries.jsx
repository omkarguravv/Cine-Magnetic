...
function AllSeries() {
  ...
  async function getMovieData() {
    const data = await fetch(
      `${import.meta.env.VITE_API_URL}/tv/popular?api_key=${
  ...
  return series.length === 0 ? (
    ...
    <>
      <h1 className="flex text-2xl md-text-4xl justify-center ">
        {" "}
        <div className="bg-[#31B78F] flex  text-white px-5 py-2 rounded-lg justify-center items-center ">
          Series 🔥
        </div>
      </h1>
